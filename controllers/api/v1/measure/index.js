...
/// ZMIANY
    ...
    router.get('/', function (req, res) {
                ...
                if (typeof req.body.user_id === 'undefined' || typeof req.body.sensor_id === 'undefined' || typeof req.body.offset === 'undefined') {
    ...
    function getMeasurements(userId, sensorId, offset){
        return new Promise(function(resolve, reject) {
                           ...
                           var db = utils.getDbConnection().then((db) => {
                                                                 ...
                                                                 db.collection('sensors').find({"user_id": userId.toString(), "_id":ObjectID.createFromHexString(sensorId.toString()), "created_epoch" : {$gte: offset} }).toArray(function (err, document) {
                                                                                                if (err) {
                                                                                                res.sendStatus(500);
                                                                                                }
